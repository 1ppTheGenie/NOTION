...
**Version:** v3 (Added Area Name to scenario - #1 PRIMARY FILTER CRITERIA)  
...
**Area Name:** [TO BE SPECIFIED] - **#1 PRIMARY FILTER CRITERIA**  
**Date Range:** October 2025 (10/01/2025 to 10/31/2025)  
...
**Note:** Area Name is the #1 criteria and must be specified. The system will:
1. Lookup AreaId from Area Name (internal, never displayed)
2. Filter campaigns by AreaId (primary filter)
3. Display Area Name in report header (user-facing)

#!/usr/bin/env python3
"""
Chargeback Dispute Response Generator - Version 6
Apple-Style with Full Terms, Pagination Footer, Complete Details

Changes in v6:
- Added beautiful Order Review Screenshot (from v2)
- Shows property image, $67.50 order, terms checkbox
- Enhanced visual proof of the order process
...
CASE_DATA = {
    ...
    'dispute_filed': 'Late December 2025',  # Need to verify exact date
...
def generate_chargeback_response(kit_dir):
    ...
    case = CASE_DATA
    version = 6  # v6 = Added order review screenshot
...
if __name__ == "__main__":
    print("\n" + "="*80)
    print("GENERATING COMPLETE CHARGEBACK RESPONSE v6")
    print("Order Review Screenshot | Full Terms | Verified WHMCS Data")
    print("="*80)

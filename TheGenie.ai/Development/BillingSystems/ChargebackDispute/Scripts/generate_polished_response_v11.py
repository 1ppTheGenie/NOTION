...
def generate_chargeback_response(kit_dir):
    ...
    case = CASE_DATA
    version = 11  # v11 = Fixed page count (was showing 11 of 12 on last page)
    ...
    TOTAL_PAGES = 11  # v11: Corrected page count
...
if __name__ == "__main__":
    print("\n" + "="*80)
    print("GENERATING FINAL CHARGEBACK RESPONSE v10")
    print("FINAL VERSION | No Widows | Fixed Email Table | No Hot URLs | 2 Engagements")
    print("="*80)

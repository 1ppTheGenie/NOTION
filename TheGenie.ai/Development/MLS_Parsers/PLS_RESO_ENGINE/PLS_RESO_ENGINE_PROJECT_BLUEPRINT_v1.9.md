...
9. User reviews pre-populated data, flags conflicts
    ↓
10. User uploads photos
    ↓
11. User generates AI description (optional)
    ↓
12. User selects status (Coming Soon/Private)
    ↓
13. User clicks "Save & Generate Content Kit"
    ↓
14. System generates XML, triggers GenieCloud render
    ↓
15. User sees "Generating..." status
    ↓
16. System displays collection URL when ready
```
...
#### Step 8: Photo Upload
**UI:** PlsPhotoUploadComponent (drag-and-drop)  
**API:** `POST /api/pls/upload-photo`  
**Backend:** S3 upload service  
**Storage:** `https://genie-cloud.s3.us-west-1.amazonaws.com/genie-pages/pls100000a/photos/photo1.jpg`  
**Requirement:** Minimum 1 photo required

**Database:**
```sql
INSERT INTO MlsListing.dbo.Photo (ListingID, MlsID, PhotoUrl, DisplayOrder)
VALUES (@ListingID, 777, @PhotoUrl, @DisplayOrder)
```

#### Step 9: AI Description Generation
**UI:** "Generate with AI" button  
**API:** `POST /api/pls/generate-description`  
**Backend:** Paisley AI integration (ChatStartTypeId=3)  
**Request:**
```json
{
  "chatStartTypeId": 3,
...
#### Step 11-14: Save Listing & Generate PLS Number

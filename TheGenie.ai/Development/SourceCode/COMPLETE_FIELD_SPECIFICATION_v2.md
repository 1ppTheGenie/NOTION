# Complete Field Specification v2 - Dave Higgins October 2025 Report
...
| 16831 | 2025-10-06 | 1063 Clarendon Crescent | SFR | Active | 150 |
...
| 2   | 16831 | Competition Command |
| 3   | 16833 | Competition Command |
| 4   | 16834 | Competition Command |
| 5   | 16843 | Competition Command |
...
| 2   | 16831 | 1063 Clarendon Crescent |
| 3   | 16833 | 3032 22nd Ave |
| 4   | 16834 | 103 Diablo Dr |
| 5   | 16843 | 2785 Butters Dr |
...
| 2   | 16831 | [QUERY: COUNT NotificationQueue WHERE PropertyCollectionDetailId parsed from CustomData JSON = 16831] |
...
| 2   | 16831 | [QUERY: (delivered+sent) / total * 100 for campaign 16831] |
...
| 2   | 16831 | [QUERY: COUNT TwilioOptOut WHERE Phone IN (SELECT ToPhone FROM NotificationQueue for campaign 16831)] |
...
| 2   | 16831 | [CALCULATED: OptOuts / MessagesSent * 100] |
...
| 2   | 16831 | [QUERY: COUNT GenieLead WHERE PropertyCollectionDetailId = 16831] |
...
| 2   | 16831 | [CALCULATED: InitialClickCount / MessagesSent * 100] |
...
| 2   | 16831 | [QUERY: COUNT CtaEvent WHERE PropertyCollectionDetailId = 16831 AND Tag LIKE 'CTA%Accept'] |
...
| 2   | 16831 | [QUERY: COUNT CtaEvent WHERE PropertyCollectionDetailId = 16831 AND Tag = 'CtaContactVerified'] |
...
| 2   | 16831 | [QUERY: COUNT NotificationQueue WHERE PropertyCollectionDetailId = 16831 AND UserNotificationId IS NOT NULL] |
...
| 2   | 16831 | [QUERY: SUM ABS(TwilioMessage.Price) for agent notifications for campaign 16831] |
...
| 2   | 16831 | [QUERY: SUM ABS(TwilioMessage.Price) for ALL SMS (audience + agent) for campaign 16831] |
...
| 2   | 16831 | [QUERY: MIN NotificationQueueId WHERE PropertyCollectionDetailId = 16831 AND UserNotificationId IS NULL] |
...
| 2   | 16831 | [QUERY: MIN MessageText WHERE PropertyCollectionDetailId = 16831 AND UserNotificationId IS NULL] |
...
| 2   | 16831 | [QUERY: MIN CtaId WHERE PropertyCollectionDetailId = 16831 AND UserNotificationId IS NULL] |
...
| 2   | 16831 | [QUERY: Extract LandingPageUrl from NotificationQueue.CustomData JSON for campaign 16831] |
...
- PropertyCollectionDetailId: 16819, 16831, 16833, 16834, 16843
- All have "SMS" in CampaignName
- All have "Competition Command" as product type
